...
parser.add_argument(
    ...
    type=float,
    required=True,
    help='Temperature is required',
    location='json',
)
parser.add_argument(
    'humidity', type=float, required=True, help='Humidity is required', location='json'
)
parser.add_argument(
    'pressure', type=float, required=True, help='Pressure is required', location='json'
)
